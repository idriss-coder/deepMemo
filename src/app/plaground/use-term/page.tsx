            ...
            <div className={"absolute top-0"}>
                ...
                <div className={"bg-bgPrimary  pt-[26px] px-[24px] pb-[24px] rounded-[20px]"}>
                    ...
                    <div className={"pt-[20px] pb-[120px] text-white/80 text-base font-medium leading-relaxed"}>
                        <h4 className={"text-lg font-bold font-['geist']"}> 1. Introduction</h4>
                        Bienvenue sur deepMemo (ci-après « l’Application »), une plateforme de quiz linguistiques et
                        éducatifs similaire. Les présentes Conditions Générales d’Utilisation (ci-après « CGU
                        »)
                        ...
                        <h4 className={"text-lg font-bold font-['geist'] mt-5"}>2. Objet</h4>
                        ...
                        <h4 className={"text-lg font-bold font-['geist'] mt-5"}>3. Inscription et Compte
                            Utilisateur</h4>
                        ...
                        <h4 className={"text-lg font-bold font-['geist'] mt-5"}>4. Utilisation de l’Application</h4>

                        Licence d’utilisation : Sous réserve du respect des présentes CGU, deepMemo vous accorde une
                        licence
                        ...
                        droits de tiers.
                        Suspension de l’accès : deepMemo se réserve le droit de suspendre ou de résilier l’accès à
                        l’Application, sans préavis, en cas de violation des présentes CGU ou de comportement
                        inapproprié.


                        <h4 className={"text-lg font-bold font-['geist'] mt-5"}> 5. Contenu et Propriété
                            Intellectuelle</h4>

                        Contenu deepMemo : Tous les éléments présents sur l’Application (textes, graphiques, logos,
                        sons,
                        vidéos, quiz, etc.) sont la propriété exclusive de deepMemo ou de ses concédants et sont
                        protégés
                        ...
                        accordez à
                        deepMemo une licence mondiale, gratuite et non exclusive pour l’affichage et la diffusion du
                        contenu
                        ...
                        <h4 className={"text-lg font-bold font-['geist'] mt-5"}> 6. Modalités Financières</h4>
                        ...
                        <h4 className={"text-lg font-bold font-['geist'] mt-5"}> 7. Protection de la Vie Privée</h4>
                        ...
                        <h4 className={"text-lg font-bold font-['geist'] mt-5"}>8. Limitation de Responsabilité</h4>

                        Disponibilité de l’Application : deepMemo met en œuvre tous les moyens raisonnables pour assurer
                        la
                        ...
                        loi,
                        deepMemo exclut toute garantie explicite ou implicite, y compris les garanties de qualité
                        marchande,
                        d’adaptation à un usage particulier ou de non-contrefaçon.
                        Responsabilité limitée : Dans la mesure permise par la loi, deepMemo ne pourra être tenu
                        responsable
